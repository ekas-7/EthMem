    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <div className="flex items-center mb-2">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Financial Advisory</h1>
            <p className="text-gray-600">Portfolio analysis and investment guidance</p>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-6 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent h-24 font-mono text-sm"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent h-20"
          ...
          {advisory && !isLoading && (
            <div className="mt-6 bg-white rounded-xl shadow-lg p-6 space-y-6">
              ...
              <div className="border-l-4 border-yellow-500 pl-4 bg-yellow-50 p-4 rounded-r-lg">
                ...
                <p className="text-gray-600 leading-relaxed">{advisory.analysis}</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="text-gray-600 capitalize">{advisory.risk_assessment}</p>
                </div>

                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    <AlertTriangle size={20} className="text-blue-600 mr-2" />
                    <h3 className="font-semibold text-gray-700">Risk Tolerance</h3>
                  </div>
                  <p className="text-gray-600 capitalize">{riskTolerance}</p>
                </div>
              </div>
              ...
              {advisory.suggested_actions && advisory.suggested_actions.length > 0 && (
                <div>
                  <h3 className="font-semibold text-gray-700 mb-3">Suggested Actions</h3>
