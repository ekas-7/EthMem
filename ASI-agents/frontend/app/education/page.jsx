    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <div className="flex items-center mb-2">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Education System</h1>
            <p className="text-gray-600">Personalized AI tutoring with adaptive learning</p>
          </div>
        </div>
      </div>
          ...
          {tutoring && !isLoading && (
            <div className="mt-6 bg-white rounded-xl shadow-lg p-6 space-y-6">
              ...
              <div className="border-l-4 border-purple-500 pl-4 bg-purple-50 p-4 rounded-r-lg">
                ...
                <p className="text-gray-600 leading-relaxed">{tutoring.explanation}</p>
              </div>
                  ...
                  <div className="space-y-3">
                    {tutoring.examples.map((example, index) => (
                      <div key={index} className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        ...
                        <p className="text-gray-600 ml-8">{example}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {tutoring.additional_resources && tutoring.additional_resources.length > 0 && (
                <div>
                  <h3 className="font-semibold text-gray-700 mb-3">Additional Resources</h3>
