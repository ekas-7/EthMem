...
export default function Header() {
  return (
    <header className="bg-gradient-to-br from-[#0B1221] to-[#01050E] rounded-b-xl p-8 text-white relative overflow-hidden">
      <nav className="flex justify-between items-center mb-16">
        <div className="flex items-center space-x-2">
          <span className="material-icons text-primary text-3xl">memory</span>
        ...
        <button className="bg-primary hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md">
          Connect Wallet
        </button>
      </nav>
      ...
      <div className="text-center">
        <h1 className="text-5xl md:text-7xl font-extrabold mb-4 leading-tight">
          Unified LLM Memory —<br /> <span className="text-primary">Your Blockchain Identity.</span>
        </h1>
        ...
        <div className="flex justify-center">
          <button className="bg-primary hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-md flex items-center">
