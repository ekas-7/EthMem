    ...
    <section className="bg-gradient-to-br from-[#07120B] to-[#052116] rounded-xl p-8 md:p-16 my-24 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">Choose how you commit to your decentralized identity — flexible, developer-friendly, and built for web3-first users.</p>
          ...
          <div className="inline-flex items-center bg-[#062017] rounded-full p-1 mt-6 shadow-sm">
            ...
            <button className="py-1 px-4 rounded-full text-sm text-gray-300">Stake for Access</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="bg-[#071816] p-10 rounded-3xl border border-emerald-900 flex flex-col">
            <div className="mb-6">
              <h3 className="text-xl font-semibold">Pioneer</h3>
              <p className="text-gray-400 text-sm mt-1">For individuals getting started</p>
            </div>

            <div className="mt-auto">
              <p className="text-3xl md:text-4xl font-bold mb-6">Free</p>
              <button className="w-full bg-transparent border border-emerald-600 hover:bg-emerald-600/10 text-emerald-300 font-semibold py-3 rounded-full mb-8">Claim Identity</button>
          ...
          {/* Voyager - highlighted */}
          <div className="bg-emerald-400 p-10 rounded-3xl border-2 border-emerald-300 relative flex flex-col">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-semibold text-black">Voyager</h3>
