export default function HowItWorks() {
  return (
    <section className="text-center my-24 px-4">
      <div className="inline-block bg-emerald-100 text-emerald-700 text-xs md:text-sm font-semibold px-4 py-1 rounded-full mb-4">
        HOW IT WORKS
      </div>

      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4 max-w-4xl mx-auto">
      ...
      <div className="max-w-3xl mx-auto">
        {/* Pale outer card */}
        <div className="bg-gray-100 rounded-3xl p-12 sm:p-16 shadow-inner flex justify-center items-center">
          {/* Inner white card with subtle shadow */}
          <div className="bg-white rounded-xl p-6 sm:p-8 shadow-2xl w-full max-w-lg">
            <img
              alt="zKMem dashboard"
              src="/next.svg"
